...
public class TabVideoButtonView extends View {
    ...
    public TabVideoButtonView(Context context) {
        super(context);
        init(context);
    }

    public TabVideoButtonView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TabVideoButtonView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    //    getDisplayWidth((Activity) mContext) / 2    Y+1.732*25*one
    @Override
