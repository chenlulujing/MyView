...
public class FloatingActionButton extends FrameLayout {
    ...
    private View mGlobleBG;

    public View getBgView() {
        return bgView;
    }

    public View getGlobleBgView() {
        return mGlobleBG;
    }
    ...
    public void attach(ViewGroup.LayoutParams layoutParams) {
        if (systemOverlay) {
            ...
            //添加全局的背景色
            if (mGlobleBG == null) {
                mGlobleBG = new View(getContext());
                mGlobleBG.setBackgroundColor(Color.parseColor("#8C000000"));
                mGlobleBG.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {

                    }
                });
                ((ViewGroup) getActivityContentView()).addView(mGlobleBG, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
                mGlobleBG.setVisibility(View.GONE);
            }

            if (bgView == null) {
                bgView = new ImageView(getContext());
                ...
                ((ViewGroup) getActivityContentView()).addView(bgView, layoutParams);
            }
    ...
    public void detach() {
        if (systemOverlay) {
            ...
            if (mGlobleBG != null) {
                ((ViewGroup) getActivityContentView()).removeView(mGlobleBG);
            }
            if (bgView != null) {
                ((ViewGroup) getActivityContentView()).removeView(bgView);
            }
        }
    }
